...
?>	
	...
	<div id="menu" class="box">
		<ul class="box f-right">
			<li><a href="../home.php"><span style="color:#3C0;"><strong>Visit Site &raquo;</strong></span></a></li>
		</ul>
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
			...
			<h3 class="tit">DAFTAR PESAN</h3>
		<?php
			$check = mysql_query("SELECT * FROM kontak") or die(mysql_error());
		...
		<?php
			...
			$query = mysql_query("SELECT * FROM kontak ORDER BY tanggal asc LIMIT $posisi,$batas") or die(mysql_error());
			while($admin = mysql_fetch_array($query)){
		?>	
					<tr>
						<td><?php echo $admin['id_pesan']; ?></td>
						<td><?php echo $admin['pengirim']; ?></td>
						<td><?php echo $admin['tanggal']; ?></td>
						<td><?php echo $admin['waktu']; ?></td>
						<td><a href="msg.php?id_pesan=<?php echo $admin['id_pesan']; ?>">Show</a></td>
						<td><a href="function/delete_pesan.php?id_pesan=<?php echo $admin['id_pesan'];?>">Delete</a></td>
					</tr>
		<?php
			}
		?>			
			...
			<?php	
								...
								echo "<p>Jumlah Pesan :  <font color=green><b>$jmldata</b></font></p>";
				}else{
