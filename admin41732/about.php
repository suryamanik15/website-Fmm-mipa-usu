...
?>	
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
			...
			<h3 class="tit">TENTANG SISTEM</h3>
				<img src="tmp/image/33.jpg" width="300px" height="300px" align="left" />
				<p> Sistem ini dilengkapi beberapa fitur yang dapat memudahkan Sys Admin (Administrator) website HMM FMIPA untuk terus memanajemen data yang terdapat pada website. Sistem ini dibuat dengan maksud untuk mempermudah para Sys Admin dalam memanajemen konten web, meng-<i>update</i> konten dan melakukan operasi <b>CRUD</b> (Create, Read, Update and Delete).Semoga dengan adanya sistem admin ini, para Sys Admin tidak perlu capek-capek merubah <i>source code</i> HTML untuk melakukan posting informasi ke website.</p>
		</div> <!-- /content -->
