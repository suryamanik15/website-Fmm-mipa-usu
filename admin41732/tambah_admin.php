...
?>	
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
			...
			<h3 class="tit">TAMBAH ADMIN</h3>
			<fieldset>
				<legend>Form Tambah Admin</legend>
				<form action="function/insert_admin.php" method="post" >
				<table class="nostyle" cellpadding="5" cellspacing="10">
					<tr>
						<td style="width:70px;" class="bold">USERNAME</td>
                        <td class="bold"> : </td>
						<td><input type="text" size="40" name="username" class="input-text" onfocus="show_info()" />
                        	<p class="msg info">Masukkan Username Baru sebagai Admin</p>
                        </td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2" class="t-right"><input type="submit" class="input-submit" value="Tambah" /></td>
					</tr>
				</table>
				</form>
			</fieldset>
