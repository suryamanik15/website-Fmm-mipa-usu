...
<?php
	...
	$sql = mysql_query("SELECT * FROM kti_list_member WHERE id_kti='$id' AND nama = '$nama'") or die(mysql_error());
...
?>
	...
	?>	
			<fieldset>
				...
				<form action="function/update_kti.php" method="post" enctype="multipart/form-data">
				<table class="nostyle" cellpadding="5" cellspacing="10">
					...
					<tr>
                        ...
                        <td class="bold"> : </td>
						<td><input type="file" size="60" name="img" class="input-text"  value="<?php echo $data['image']; ?>"/>
                        </td>
					</tr>
					<tr>
		...
		<?
				...
				$sq = mysql_query("SELECT * FROM tbl_kti WHERE id_kti='$id'") or die(mysql_error());
				$f = mysql_fetch_array($sq);
		?>		
				<fieldset>
				<legend>Form Edit Data</legend>
				<form action="function/update_tim_kti.php" method="post" enctype="multipart/form-data">
				<table class="nostyle" cellpadding="5" cellspacing="10">
					<tr>
						<td style="width:70px;" class="bold">ID Registrasi : </td>
                        <td class="bold"> : </td>
						<td><input type="text" size="40" name="id_reg" class="input-text"  readonly="readonly" value="<?php echo $f['id_kti']; ?>"/>
                        </td>
					</tr>
					<tr>
					...
					<tr>
						<td style="width:70px;" class="bold">Reg Date : </td>
                        <td class="bold"> : </td>
						<td><input type="text" size="40" name="reg_date" class="input-text" readonly="readonly"  value="<?php echo $f['tgl_daftar']." ".$f['waktu_daftar']; ?>"/>
                        </td>
					</tr>
					<tr>
						<td colspan="2" class="t-right"><input type="submit" class="input-submit" value="Submit" /></td>
