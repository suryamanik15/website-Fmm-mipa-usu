...
<?php
	...
	$sql = mysql_query("SELECT * FROM tbl_puisi WHERE id_reg='$id'") or die(mysql_error());
...
?>
			...
			<fieldset>
				...
				<form action="function/update_puisi.php" method="post" enctype="multipart/form-data">
				<table class="nostyle" cellpadding="5" cellspacing="10">
					...
					<tr>
                        ...
                        <td class="bold"> : </td>
						<td><input type="text" size="40" name="telp" class="input-text"  value="<?php echo $data['handphone']; ?>"/>
                        </td>
					</tr>
					<tr>
					...
					<tr>
                        ...
                        <td class="bold"> : </td>
						<td><input type="text" size="40" name="email" class="input-text"  value="<?php echo $data['email']; ?>"/>
                        </td>
					</tr>
					<tr>
						<td style="width:70px;" class="bold">Asal Kota  </td>
                        <td class="bold"> : </td>
						<td><input type="text" size="40" name="asal_kota" class="input-text"  value="<?php echo $data['asal_kota']; ?>"/>
                        </td>
					</tr>
					<tr>
						<td style="width:70px;" class="bold">Alamat Sekolah  </td>
                        <td class="bold"> : </td>
						<td><input type="text" size="40" name="alamat_sekolah" class="input-text"  value="<?php echo $data['alamat_sekolah']; ?>"/>
                        </td>
					</tr>
					<tr>
						<td style="width:70px;" class="bold">Judul Puisi  </td>
                        <td class="bold"> : </td>
						<td><input type="text" size="40" name="judul_puisi" class="input-text"  value="<?php echo $data['judul_puisi']; ?>"/>
                        </td>
					</tr>
					<tr>
