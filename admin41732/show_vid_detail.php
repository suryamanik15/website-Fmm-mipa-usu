...
<?php
	...
	$sql = mysql_query("SELECT * FROM tim_video WHERE id_tim='$id'") or die(mysql_error());
...
?>
			...
			<?
				$sq = mysql_query("SELECT * FROM vid_list_member WHERE id_tim = '$id'") or die(mysql_error());
				...
				<fieldset>
					<table border="0" cellpadding="5" cellspacing="10">
						...
						<tr>
							...
							<td>
							<?	
							if(!file_exists("../RPanel/files/video_lagu/".$mem->img_name)){
								echo "<img width=\"100\" height=\"100\"  src=\"../RPanel/image/placeholder.gif\" />";
							}else{
								echo "<img width=\"100\" height=\"100\" src=\"../RPanel/files/video_lagu/".$mem->img_name."\" />";
							}
							?>							
							</td>
						</tr>
						<tr>
							<td>Edit</td>
							<td> : </td>
							<td><a href="edit_vid.php?id=<? echo $id;?>&nama=<? echo $mem->nama;?>">Edit</a></td>
						</tr>
					</table>
				</fieldset><br/>
			<?
