...
$Q1 = mysql_query("SELECT * FROM tim_video WHERE id_tim = '$id'") or die(mysql_error());
$Q2 = mysql_query("SELECT * FROM vid_list_member WHERE id_tim = '$id'") or die(mysql_error());
...
$html = '
<center><h1>KARTU PESERTA LOMBA VIDEO LAGU</h1></center>
...
<p>
	<table border = "0" cellspacing="5" cellpadding="2">
		<tr>
			<td>ID Tim</td>
			<td> : </td>
			<td><span style="color:green;">'.$data->id_tim.'</span></td>
		</tr>
		<tr>
			<td>Nama Tim</td>
			<td> : </td>
		...
		<tr>
			<td>Judul Lagu</td>
			<td> : </td>
			<td><span style="color:green;">'.$data->judul_lagu.'</span></td>
		</tr>
		<tr>
			<td>Email</td>
			<td> : </td>
...
while($list = mysql_fetch_object($Q2)){
	$html .= '<p><img src="./RPanel/files/video_lagu/"'.$list->img_name.'" align="left" width="50" height="50">
				 <table border="0">
					<tr>
