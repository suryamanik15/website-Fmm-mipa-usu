...
<div class="container">
    ...
    <div class="divPanel page-content">
        ...
        <div class="breadcrumbs">
                <a href="hmm-fmipausu.org">Home</a> &nbsp;/&nbsp; <span>Form Registrasi Karya Tulis Ilmiah</span>
            </div> 
		...
		<?php
			...
			if(!isset($mode)){
		?>
                    <h1>Form Registrasi Peserta Lomba Karya Tulis Ilmiah</h1>
					
						<label>Pilih Jumlah Anggota (<i>maksimal 3 orang</i>): </label>
						<select id="num_anggota" onchange="change_anggota()" name="angg">
								<option value="" selected="selected">======Jumlah Anggota=====</option>
							<?
								for($i = 1; $i <= 3; $i++){
					...
					<form id="form_registration" method="POST" action="./index.php?View=User&Menu=Submit_Reg_Karya_Tulis" enctype="multipart/form-data">
						<label>Nama Tim :</label>
						<span style="color:red;"><input class="input-large" type="text" name="nama_tim" id="nama_tim" placeholder="Nama Tim Anda"></span>
						<br/><br/>
						<label>Asal Sekolah :</label>
						<span style="color:red;"><input class="input-large" type="text" name="asal_sekolah" id="asal_Sekolah" placeholder="Asal Sekolah Anda"></span>
						<br/><br/>
						<label>Email Tim :</label>
						<span style="color:red;"><input class="input-large" type="text" name="email" id="email"></span>
						<br/><br/>
						<fieldset>
							<legend>Biodata Ketua Tim</legend>
							<label>Nama Ketua Tim :</label>
								<span style="color:red;"><input class="input-large" type="text" name="nama_ketua" id="nama_ketua" placeholder="Nama Ketua Tim"></span><br/>
							<label>Tempat Lahir :</label>
								<span style="color:red;"><input class="input-large" type="text" name="tmp_lahir_k"  id="tk"></span><br/>
							<label>No. Telp/HP :</label>
								<span style="color:red;"><input class="input-large" type="text" name="hp_k"  id="hpk"></span><br/>	
