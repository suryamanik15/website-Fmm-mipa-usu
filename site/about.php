                   ...
                   <div class="navbar">
                        ...
                        <div class="nav-collapse collapse">
                            <ul class="nav nav-pills ddmenu">
								...
								<li class="dropdown active"><a href="./index.php?View=User&Menu=About">Tentang Kami</a></li>
                                <li class="dropdown">
...
<div class="container">
    ...
    <div class="divPanel page-content">
        ...
        <div class="breadcrumbs">
                <a href="index.html">Home</a> &nbsp;/&nbsp; <span>Tentang Kami</span>
            </div> 
        ...
        <div class="row-fluid">
                <div class="span8" id="divMain">
                    ...
                    <img src="./site/images/hmm1.png" class="img-polaroid" style="margin:12px 0px;">  </p>    
                                                     
                    <p>Himpunan ini terdiri dari banyak cabang divisi. Dan setiap Divisi mempunyai visi dan misi sendiri. Namun visi dan misi kami 
					kedepannya adalah membangun kehidupan bermasyarakat dengan penerapan <i>Science</i>.</p>
					<p>Sebagai upaya dalam memajukan bidang <i>Science</i>, himpunan juga melakukan beberapa kegiatan yang menunjang bidang
					tersebut. Hal itu dapat diimplementasikan dengan adanya berbagai kompetisi <i>Science</i> baik antar mahasiswa hingga 
					sampai ke tingkat pelajar.</p>
					...
					if($num_of_news <= 0){
						...
						echo "</div>";
							...
							while($news_data = mysql_fetch_object($news_Q)){
									...
									echo "<div class=\"span8\"> ";
									echo "<p>".$sub->seeMore($news_data->isi)."<a href='./index.php?View=User&Menu=Page&id_post=".$news_data->id_posting."'>Selengkapnya</a> </p>";
									echo "</div>";
									echo "</div>";
							}
					}		
