...
<div class="container">
    ...
    <div class="divPanel page-content">
        ...
        <div class="breadcrumbs">
                <a href="hmm-fmipausu.org">Home</a> &nbsp;/&nbsp; <span>Form Registrasi Lomba Puisi Tingkat SMP dan SMA.</span>
            </div> 
		...
		<?php
			...
			if(!isset($mode)){
		?>
                    <h1>Form Registrasi Lomba Puisi Tingkat SMP dan SMA</h1>
					<form id="form_registration" method="POST" action="./index.php?View=User&Menu=Submit_Puisi" enctype="multipart/form-data">
						<label>Nama Anda :</label>
						<span style="color:red;"><input class="input-large" type="text" name="nama" id="nama" placeholder="Nama Lengkap Anda"></span>
						<br/><br/>
						<label>Tempat Lahir :</label>
						<span style="color:red;"><input class="input-large" type="text" id="tmp_lahir" name="tmp_lahir"></span>
						<br/><br/>
						...
						<br/>
						<label>Alamat :</label>
							<span style="color:red;"><input class="input-large" type="text" name="alamat" id="alamat"></span>
						<br/><br/>
						<label>No. HP/Telp :</label>
							<span style="color:red;"><input class="input-large" type="text" id="telp" name="no_hp"></span><br/>
						<label>Email :</label>
							<span style="color:red;"><input class="input-large" type="text" name="email" id="email"></span><br/>
						<label>Asal Kota :</label>
							<span style="color:red;"><input class="input-large" type="text" name="kota" id="kota"></span><br/>
						<label>Judul Puisi :</label>
							<span style="color:red;"><input class="input-large" type="text" name="judul_puisi" id="judul_puisi"></span><br/>
						<label>Asal Sekolah :</label>
							<span style="color:red;"><input class="input-large" type="text" name="asal_sekolah" id="asal"></span><br/>		
						<label>Alamat Sekolah:</label>
							<span style="color:red;"><input class="input-large" type="text" name="alamat_sekolah" id="alamat_sekolah"></span><br/>	
						<label>Upload Foto Anda :</label>
							<input class="input-large" type="file" name="upload"><br/>
						<br/>
			...
			<?php
					...
					if($mode == "success"){
						...
						echo "<strong>".$message."</strong>, <br/>silahkan registrasi kembali di 
								<strong><a href=\"./index.php?View=User&Menu=Reg_Karya_Tulis\">sini</a><strong> !!</strong>";
						echo "</div>";
					}
				}
			?>	
...
<script>
	$(document).ready(function(){
		$('#num_anggota').change(function(){
			var nilai = $(this).val();
			document.location.href="./index.php?View=User&Menu=Reg_Karya_Tulis&num_member="+nilai;
		});
